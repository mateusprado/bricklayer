...
from cyclone.tw.resource import IResource
from cyclone.tw.server import NOT_DONE_YET
from cyclone.tw.http import INTERNAL_SERVER_ERROR
...
class _WSGIResponse:
    ...
    def _sendResponseHeaders(self):
        ...
        # cyclone.tw.server.Request.process always addes a content-type
