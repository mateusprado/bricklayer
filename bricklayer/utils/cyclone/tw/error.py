# -*- test-case-name: cyclone.tw.test.test_error -*-
# Copyright (c) 2001-2010 Twisted Matrix Laboratories.
# See LICENSE for details.

"""
Exception definitions for L{cyclone.tw}.
"""
...
from cyclone.tw import resource as _resource

class ErrorPage(_resource.ErrorPage):
    """
    Deprecated alias for L{cyclone.tw.resource.ErrorPage}.
    """
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "cyclone.tw.error.ErrorPage is deprecated since Twisted 9.0.  "
            "See cyclone.tw.resource.ErrorPage.", DeprecationWarning,
            stacklevel=2)
...
class NoResource(_resource.NoResource):
    """
    Deprecated alias for L{cyclone.tw.resource.NoResource}.
    """
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "cyclone.tw.error.NoResource is deprecated since Twisted 9.0.  "
            "See cyclone.tw.resource.NoResource.", DeprecationWarning,
            stacklevel=2)
...
class ForbiddenResource(_resource.ForbiddenResource):
    """
    Deprecated alias for L{cyclone.tw.resource.ForbiddenResource}.
    """
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "cyclone.tw.error.ForbiddenResource is deprecated since Twisted "
            "9.0.  See cyclone.tw.resource.ForbiddenResource.",
