# -*- test-case-name: cyclone.tw.test.test_distrib -*-
...
from cyclone.tw import http, resource, server, html, static
...
<html>
    <head>
    <title>cyclone.tw.distrib.UserDirectory</title>
    <style>
    ...
    <body>
    <h1>cyclone.tw.distrib.UserDirectory</h1>
