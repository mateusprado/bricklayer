# -*- test-case-name: cyclone.tw.test.test_cgi -*-
...
from cyclone.tw import resource, server, static
...
class PHP3Script(FilteredScript):
    ...
    deprecatedModuleAttribute(
        ...
        "PHP3Script is deprecated. Use cyclone.tw.twcgi.FilteredScript "
        "instead.",
        __name__, "PHP3Script")
...
class PHPScript(FilteredScript):
    ...
    deprecatedModuleAttribute(
        Version("Twisted", 10, 1, 0),
        "PHPScript is deprecated. Use cyclone.tw.twcgi.FilteredScript "
        "instead.",
        __name__, "PHPScript")
