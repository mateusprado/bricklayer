# -*- test-case-name: cyclone.tw.test.test_web -*-
...
class Resource:
    ...
    def getChild(self, path, request):
        ...
        @param request: a cyclone.tw.server.Request specifying meta-information
    ...
    def render(self, request):
        ...
        cyclone.tw.server.NOT_DONE_YET, in which case it is this
        ...
        if not m:
            ...
            # below three error resources in cyclone.tw.error are removed.
            from cyclone.tw.error import UnsupportedMethod
