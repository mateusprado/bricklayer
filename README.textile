...
Bricklayer uses twisted to serve a restful interface as well as the scheduler interface, it also needs sqlalchemy to save projects in a sqlite database (works with any other database supported by sqlalchemy). They are already included in the project.
